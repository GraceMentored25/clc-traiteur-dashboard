...
export const DEFAULT_MATERIEL: Materiel[] = [
  { id: "marmite-chauffe", name: "Marmite chauffante", unit: "unité", stockQty: 0 },
  { id: "bain-marie", name: "Bain-marie électrique", unit: "unité", stockQty: 0 },
  { id: "plaque-chauff", name: "Plaque chauffante", unit: "unité", stockQty: 0 },
  { id: "gaziniere", name: "Gazinière portable", unit: "unité", stockQty: 0 },
  { id: "bouteille-gaz", name: "Bouteille de gaz", unit: "unité", stockQty: 0 },
  { id: "grande-marmite", name: "Grande marmite 40L", unit: "unité", stockQty: 0 },
  { id: "bassine", name: "Bassine inox", unit: "unité", stockQty: 0 },
  { id: "louche", name: "Louche de service", unit: "unité", stockQty: 0 },
  { id: "assiette-service", name: "Assiette de service", unit: "unité", stockQty: 0 },
  { id: "couvert-service", name: "Couverts de service", unit: "set", stockQty: 0 },
  { id: "nappe", name: "Nappe de table", unit: "unité", stockQty: 0 },
  { id: "tente-reception", name: "Tente de réception", unit: "unité", stockQty: 0 },
  { id: "table-pliante", name: "Table pliante", unit: "unité", stockQty: 0 },
  { id: "chaise-pliante", name: "Chaise pliante", unit: "unité", stockQty: 0 },
  { id: "panneau-deco", name: "Panneau de décoration", unit: "unité", stockQty: 0 },
  { id: "centrepiece", name: "Centrepiece floral", unit: "unité", stockQty: 0 },
  { id: "lumiere-deco", name: "Éclairage décoratif", unit: "set", stockQty: 0 },
  { id: "sono", name: "Système sonore", unit: "unité", stockQty: 0 },
  { id: "sac-poubelle", name: "Sac poubelle 100L", unit: "rouleau", stockQty: 0 },
  { id: "gants-cuisine", name: "Gants de cuisine", unit: "paire", stockQty: 0 },
];
