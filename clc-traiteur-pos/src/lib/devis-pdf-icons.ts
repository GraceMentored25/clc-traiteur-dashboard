...
const CATEGORY_ICONS: Record<string, string> = {
  "Apéritifs": '<svg aria-hidden="true" focusable="false" class="lucide lucide-grape" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 5V2l-5.89 5.89"/><circle cx="16.6" cy="15.89" r="3"/><circle cx="8.11" cy="15.89" r="3"/><circle cx="12.35" cy="3" r="3"/><circle cx="2.87" cy="8.26" r="3"/><circle cx="6.24" cy="21.61" r="3"/><circle cx="21.13" cy="8.26" r="3"/></svg>',
