...
/** Plat sous cloche (plats cuisinés / repas). */
export const PLAT_CUISINES_ICON =
  ...
  '<path d="M4.5 16.75c0-2.15 3.35-3.75 7.5-3.75s7.5 1.6 7.5 3.75"/>' +
  '<path d="M7.75 16.75V12.2a4.25 4.25 0 0 1 8.5 0v4.55"/>' +
